...
def pop(self,behaviour):
  ...
  update  - updates position of popover - useful for dynamic content that changes 
            the size of the popover
  is_visible: returns True or False if the popover is visible - note a popover 
              will only be visible after it has animated onto screen so may need 
              to sleep(.15) before calling """
